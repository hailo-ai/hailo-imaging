 ...
 * - @ref module_name
 *
 * @defgroup IMX662_priv
 * @{
 *
 */
#ifndef __IMX662_PRIV_H__
#define __IMX662_PRIV_H__
...
#undef TRACE
#define TRACE(level,...) \
if(level == IMX662_DEBUG) ALOGD(__VA_ARGS__); \
if(level == IMX662_REG_DEBUG) ALOGD(__VA_ARGS__); \
if(level == IMX662_INFO) ALOGI(__VA_ARGS__); \
if(level == IMX662_REG_INFO) ALOGI(__VA_ARGS__); \
if(level == IMX662_WARN) ALOGW(__VA_ARGS__); \
if(level == IMX662_ERROR) ALOGE(__VA_ARGS__);
...
typedef struct IMX662_Context_s
{
    ...
    float               hdr_ratio[2]; // [0]: long/short, [1]: unused for now (SDR only)
} IMX662_Context_t;



static RESULT IMX662_IsiUnlimitFpsIss(IsiSensorHandle_t handle, float maxIntegrationTime);
static RESULT IMX662_IsiLimitFpsIss(IsiSensorHandle_t handle);
static RESULT IMX662_IsiSetFlickerFpsIss(IsiSensorHandle_t handle, uint32_t flickerMode);
...
static RESULT IMX662_IsiSetStreamingIss(IsiSensorHandle_t handle, bool_t on);
...
static RESULT IMX662_IsiGetIntegrationTimeLimitsIss(IsiSensorHandle_t handle, 
								float *pMinIntegrationTime,
								float *pMaxIntegrationTime);
static RESULT IMX662_IsiExposureControlIss(IsiSensorHandle_t handle,
								float NewGain, 
								...
								float *hdr_ratio);
static RESULT IMX662_IsiExposureControlExpandedIss(IsiSensorHandle_t handle,
								float NewGain, 
								float NewIntegrationTime,
								float NewIris,
								uint8_t *pNumberOfFramesToSkip,
...
static RESULT IMX662_IsiGetGainIss(IsiSensorHandle_t handle,float *pSetGain);

static RESULT IMX662_IsiGetLEFGainIss(IsiSensorHandle_t handle,float *pSetGain);

static RESULT IMX662_IsiGetSEF1GainIss(IsiSensorHandle_t handle,float *pSetGain);

static RESULT IMX662_IsiGetSEF2GainIss(IsiSensorHandle_t handle,float *pSetGain);

static RESULT IMX662_IsiGetGainIncrementIss(IsiSensorHandle_t handle,float *pIncr);

static RESULT IMX662_IsiSetGainIss(IsiSensorHandle_t handle,
								float NewGain, 
								float *pSetGain,
								float *hdr_ratio);

static RESULT IMX662_IsiSetLEFGainIss(IsiSensorHandle_t handle,
								float NewGain, 
								float *pSetGain,
								float *hdr_ratio);

static RESULT IMX662_IsiSetSEF1GainIss(IsiSensorHandle_t handle,
								float NewIntegrationTime,
								float NewGain, 
								float *pSetGain,
								float *hdr_ratio);

static RESULT IMX662_IsiSetSEF2GainIss(IsiSensorHandle_t handle,
								float NewIntegrationTime,
								float NewGain, 
								float *pSetGain,
								float *hdr_ratio);
...
static RESULT IMX662_IsiGetLEFIntegrationTimeIss(IsiSensorHandle_t handle,
								float *pSetIntegrationTime);

static RESULT IMX662_IsiGetSEF1IntegrationTimeIss(IsiSensorHandle_t handle,
								float *pSetIntegrationTime);

static RESULT IMX662_IsiGetSEF2IntegrationTimeIss(IsiSensorHandle_t handle,
								float *pSetIntegrationTime);

static RESULT IMX662_IsiGetIntegrationTimeIncrementIss(IsiSensorHandle_t handle,
								float *pIncr);
...
static RESULT IMX662_IsiSetLEFIntegrationTimeIss(IsiSensorHandle_t handle,
								float NewIntegrationTime, 
								float *pSetIntegrationTime,
								uint8_t *pNumberOfFramesToSkip,
								float *hdr_ratio);

static RESULT IMX662_IsiSetSEF1IntegrationTimeIss(IsiSensorHandle_t handle,
								float NewIntegrationTime,
								float *pSetIntegrationTime,
								uint8_t *pNumberOfFramesToSkip,
								float *hdr_ratio);

static RESULT IMX662_IsiSetSEF2IntegrationTimeIss(IsiSensorHandle_t handle,
								float NewIntegrationTime,
								float *pSetIntegrationTime,
								uint8_t *pNumberOfFramesToSkip,
								float *hdr_ratio);

static RESULT IMX662_IsiSetHCGIss(IsiSensorHandle_t handle,
								bool hcg_lef, bool hcg_sef1, bool hcg_sef2);

static RESULT IMX662_IsiGetHCGIss(IsiSensorHandle_t handle,
